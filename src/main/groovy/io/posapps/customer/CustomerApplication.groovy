...
//class CustomerApplication implements RequestHandler<Map, Response> {
class CustomerApplication extends SpringBootServletInitializer implements RequestHandler<Map, Response> {
    ...
    static void main(String[] args) {
        CustomerApplication.newInstance().getApplicationContext(args)
    }
    ...
    ApplicationContext getApplicationContext(String[] args = []) {
        return SpringApplication.run(CustomerApplication, args)
    }
